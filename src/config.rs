...
fn default_heartbeat_interval() -> u64 { 150 }

fn default_election_timeout_min() -> u64 { 300 }

fn default_election_timeout_max() -> u64 { 600 }

fn default_max_payload_entries() -> usize { 1000 }

fn default_to_voter_threshold() -> usize { 100 }